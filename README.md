...
3. 플레이어가 마우스 우클릭을 눌렀을때 검기라는 오브젝트가 조준하는방향에서 생성된다. 
...
# 10. 프로토타입 개발 요구사항 <a name='개발작업2'></a>
...
버그 
인벤토리 A아이템UI가 B아이템UI쪽으로 이동했을때 B아이템이 삭제됌 
...
6주차 버그 해결
bool값을 체크했을때 단발무기로 만들게한다.
거기에 단발이 클릭하면 더 빨라지게하는게 아니라 아무리빨리 클릭해도 고정속도로 유지한다.
인벤토리 시스템(50%) 구현
인벤토리일때 마우스커서 바꾸게 하기
...
## 10주차 <a name='2-10주차'></a>

### 목표: 무기 애니메이션 제작
무기를 안들고있을때는 주먹으로 공격하는 애니메이션과 검을 휘두르는 애니메이션을 제작하였습니다.
그리고 작동되는 코딩까지 구현
## 11주차 <a name='2-11주차'></a>

### 목표: 데미지 텍스트 만들기
적을 때렸을 때 데미지수치를 보여주는 텍스트를 만들었으나 아직 연결하지않았다.


## 12주차 <a name='2-12주차'></a>

### 목표: 몬스터 AI 수정
감지범위안속에 들어왔을때 계속추적하는 박쥐가 랜덤이동으로 수정했다.

## 13주차 <a name='2-13주차'></a>

### 목표: 데미지 텍스트 연동구현
적을 때렸을 때  데미지 텍스트를 나오게 연동시켰다.

## 14주차 <a name='2-14주차'></a>

### 목표: 스테이지 및 몬스터 추가 
거의 마무리 단계로 몬스터 추가와 스테이지를 늘렸다.
## 15주차 <a name='2-15주차'></a>

### 목표: 인벤토리 회복상점 구현
이제 무기를 얻으면 인벤토리에 들어가게 되며 무기슬롯에 넣으면 무기를 꺼낼수있도록 만들었다.
그리고 회복상점에서 플레이어의 골드로 회복아이템을 구매할수있다.
